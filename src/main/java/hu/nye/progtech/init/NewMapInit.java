...
public final class NewMapInit implements MapInit {
    private static final Logger LOGGER = LoggerFactory.getLogger(NewMapInit.class);
    private final Scanner scanner;

    public NewMapInit(final Scanner scanner) {
